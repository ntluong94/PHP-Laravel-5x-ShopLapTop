        ...
        <table class="table table-bordered table-hover">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                       <a href="status.php?id=<?php echo $item['id'] ?>" class=" btn btn-xs <?php echo $item['status']==0 ? 'btn-danger' : 'btn-info'?>"><?php echo $item['status']==0 ? 'Chưa giao' : 'Đã giao'  ?></a>
                        </td>
                    <td>
                        <a class="btn btn-xs btn-info" href="detail.php?id=<?php echo $item['id'] ?>"><i class="fa fa-edit"></i> chi tiết</a>
